USE [master]
GO
IF (EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE ('[' + name + ']' = N'QuickKart'OR name = N'QuickKart')))
DROP DATABASE QuickKart
GO
...
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2099299687852320,'Carlos Gonz�lez','V',244,DATEADD(YEAR, 10,'2026-01-07'),7330.00)
