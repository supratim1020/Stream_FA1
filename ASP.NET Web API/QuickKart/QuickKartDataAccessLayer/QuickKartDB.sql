...
IF (EXISTS (SELECT NAME FROM master.dbo.sysdatabases WHERE ('[' + NAME + ']' = N'QuickKartDB' OR NAME = N'QuickKartDB')))
...
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1146665296881890,'Manuel','M',137,GetDate()+10,7282.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1164283045453550,'Renate Messner','V  ',133,GetDate()+10,14538.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1164916976389880,'Rita','M',588,GetDate()+10,18570.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1172583365804160,'McKenna','V  ',777,GetDate()+10,7972.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1190676541467400,'Brown','V  ',390,GetDate()+10,9049.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1201253053391160,'Patricia','M',501,GetDate()+10,19092.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1209611246778470,'Cruz','V  ',879,GetDate()+10,13645.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1224920265219560,'Pirkko','M',771,GetDate()+10,14620.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1229664582982800,'Helen','M',402,GetDate() + 10,16932.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1245674190696670,'Mary','M',828,GetDate()+10,14078.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1258975792010020,'Annette','M',606,GetDate()+10,15889.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1299352607468300,'Saveley','V  ',161,GetDate()+10,14120.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1307313341777150,'Anne','M',684,GetDate()+10,16611.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1307984461363180,'Philip','M',663,GetDate()+10,9663.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1323958003776600,'Parente','V  ',517,GetDate()+10,7532.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1333123521082050,'Laurence','M',401,GetDate()+10,16257.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1344543094137310,'Chang','V  ',602,GetDate()+10,10822.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1353631465427820,'Paolino','V  ',435,GetDate()+10,5400.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1360271842709590,'Karin','M',878,GetDate()+10,12912.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1372132080189220,'Sommer','V  ',524,GetDate()+10,14556.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1375307422567340,'Yoshi','M',461,GetDate()+10,12344.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1386564526403300,'Carlos','M',468,GetDate()+10,6810.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1408191938746240,'Ibsen','V  ',246,GetDate()+10,7022.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1420510667654400,'Bennett','V  ',324,GetDate()+10,5724.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1422216593359170,'Aria','M',565,GetDate()+10,16016.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1429133847340950,'Martin','M',421,GetDate()+10,9567.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1431181049383360,'Matti Karttunen','M',851,GetDate()+10,6334.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1438819177663050,'Roel','V  ',641,GetDate()+10,13577.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1462257648213080,'Larsson','V  ',749,GetDate()+10,14693.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1482320853851460,'Peter','M',522,GetDate()+10,9433.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1492397474220820,'Maria','M',340,GetDate()+10,13098.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1514516790088230,'Pedro','V  ',820,GetDate()+10,6451.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1537796149367160,'Pontes','V  ',310,GetDate()+10,8675.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1555631662463540,'Henriot','V  ',779,GetDate()+10,9786.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1563901313189020,'Jaime Yorres','V  ',240,GetDate()+10,11605.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1572423633450130,'Matti','M',775,GetDate()+10,5972.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1574371302243230,'Hernadez','V  ',551,GetDate()+10,3998.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1580998908832260,'Muller','V  ',645,GetDate()+10,10031.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1589603911737880,'Lincoln','V  ',386,GetDate()+10,18947.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1598628594155670,'Karla','M',632,GetDate()+10,13292.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1608547117331400,'Rourke','V  ',494,GetDate()+10,8083.0)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1625578520990590,'Mendel','V  ',668,GetDate()+10,8736.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1644808785340540,'Lebihan','V  ',803,GetDate()+10,11121.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1656858554325890,'Paolo','V  ',480,GetDate()+10,11965.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1666406702985340,'Lesley','M',275,GetDate()+10,6934.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1670872362066270,'Ottlieb','V  ',664,GetDate()+10,3257.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1706709681608450,'Martine','M',461,GetDate()+10,6688.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1753456075904120,'Cramer','V  ',156,GetDate()+10,17721.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1762181841319160,'Victoria','V  ',846,GetDate()+10,5927.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1769660540375220,'Smith','V  ',603,GetDate()+10,3011.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1770791472481120,'Accorti','V  ',855,GetDate()+10,17423.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1770826010361760,'Koskitalo','V  ',874,GetDate()+10,15892.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1774070025907600,'Miguel','M',444,GetDate()+10,10058.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1780797319715350,'Helvetius','M',869,GetDate()+10,12015.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1787045046296090,'Domingues','V  ',335,GetDate()+10,6683.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1803781319458280,'Diego','M',744,GetDate()+10,15762.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1825594516343200,'Nagy','V  ',705,GetDate()+10,7712.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1869448663438790,'Snyder','V  ',310,GetDate()+10,15081.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1896069342213410,'Thomas','V  ',833,GetDate()+10,11755.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1905318731514900,'Sven','M',657,GetDate()+10,5759.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1930722559801600,'Pereira','V  ',556,GetDate()+10,5996.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1938972100708320,'Tonini','V  ',513,GetDate()+10,3565.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1974246182398960,'Anabela','M',204,GetDate()+10,13083.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1987863279307720,'Howard','M',331,GetDate()+10,2708.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(1996173177447140,'Davis','M',501,GetDate()+10,18212.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2017070736071510,'Franken','V  ',439,GetDate()+10,3590.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2020707634380970,'Karttunen','V  ',865,GetDate()+10,17928.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2038135301855300,'Janine','M',680,GetDate()+10,4077.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2040807464727850,'Paula','M',286,GetDate()+10,8052.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2054485375031050,'Elizabeth','M',183,GetDate()+10,6145.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2079696512053250,'Maria','M',465,GetDate()+10,6170.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2082327655038300,'Jablonski','V  ',622,GetDate()+10,14280.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2099162707660160,'Timothy','M',568,GetDate()+10,8408.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2099299687852320,'Carlos González','V  ',244,GetDate()+10,7330.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2102109985058560,'Ashworth','V  ',634,GetDate()+10,10204.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2102480159544330,'Roulet','V  ',764,GetDate()+10,2883.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2107089108224360,'Latimer','V  ',720,GetDate()+10,11387.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2112369521723620,'Carine','M',490,GetDate()+10,18773.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2119125701641590,'Schmitt','V  ',331,GetDate()+10,6182.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2121785955299770,'Palle','M',261,GetDate()+10,3655.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2122490035590690,'Margaret','M',875,GetDate()+10,18000.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2127803726103060,'Afonso','V  ',858,GetDate()+10,11726.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2136141552371090,'Rance','V  ',434,GetDate()+10,17813.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2139581656416670,'Francisco','M',727,GetDate()+10,15845.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2155938900697450,'Labrune','V  ',400,GetDate()+10,2455.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2157326961005880,'Daniel','M',827,GetDate()+10,2145.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2175932867933100,'Gary','M',635,GetDate()+10,14526.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2175974386401880,'Devon','V  ',270,GetDate()+10,3463.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2208687402112480,'Josephs','V  ',640,GetDate()+10,15794.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2210444662985580,'Paul','M',710,GetDate()+10,16523.00)
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2219617013139190,'Roland','M',719,GetDate()+10,2537.00)
GO
